...
class Backbone(nn.Module):
    ...
    def encode(self, x):
        ...
        # torch.Size([8, 1, 13, 512, 512])
        x = x.view(-1, x.size(-3), x.size(-2), x.size(-1))
        # torch.Size([8, 13, 512, 512])
        x = x.to(torch.float)
        # torch.Size([8, 32, 256, 256])
        x = F.relu(self.bn_pre_1(self.conv_pre_1(x))) # torch.Size([8, 32, 256, 256])
        x = F.relu(self.bn_pre_2(self.conv_pre_2(x))) # torch.Size([8, 32, 256, 256])

        # -------------------------------- Encoder Path --------------------------------
        # -- STC block 1
        x_1 = F.relu(self.bn1_1(self.conv1_1(x))) # torch.Size([8, 64, 128, 128])
        x_1 = F.relu(self.bn1_2(self.conv1_2(x_1))) # torch.Size([8, 64, 128, 128])

        x_1 = x_1.view(
            batch, -1, x_1.size(1), x_1.size(2), x_1.size(3)
        ).contiguous()  # (batch, seq, c, h, w) torch.Size([8, 1, 64, 128, 128])
        x_1 = self.conv3d_1(x_1) # torch.Size([8, 1, 64, 128, 128])
        x_1 = x_1.view(
            -1, x_1.size(2), x_1.size(3), x_1.size(4)
        ).contiguous()  # (batch * seq, c, h, w) torch.Size([8, 64, 128, 128])

        # -- STC block 2
        x_2 = F.relu(self.bn2_1(self.conv2_1(x_1))) # torch.Size([8, 128, 64, 64])
        x_2 = F.relu(self.bn2_2(self.conv2_2(x_2))) # torch.Size([8, 128, 64, 64])

        x_2 = x_2.view(
            batch, -1, x_2.size(1), x_2.size(2), x_2.size(3)
        ).contiguous()  # (batch, seq, c, h, w) torch.Size([8, 1, 128, 64, 64])
        x_2 = self.conv3d_2(x_2) # torch.Size([8, 1, 128, 64, 64])
        x_2 = x_2.view(
            -1, x_2.size(2), x_2.size(3), x_2.size(4)
        ).contiguous()  # (batch * seq, c, h, w), seq = 1 torch.Size([8, 128, 64, 64])

        # -- STC block 3
        x_3 = F.relu(self.bn3_1(self.conv3_1(x_2))) # torch.Size([8, 256, 32, 32])
        x_3 = F.relu(self.bn3_2(self.conv3_2(x_3))) # torch.Size([8, 256, 32, 32])

        # -- STC block 4
        x_4 = F.relu(self.bn4_1(self.conv4_1(x_3))) # torch.Size([8, 512, 16, 16])
        x_4 = F.relu(self.bn4_2(self.conv4_2(x_4))) # torch.Size([8, 512, 16, 16])
    ...
    def decode(
        ...
        x_2 = x_2.view(batch, -1, x_2.size(1), x_2.size(2), x_2.size(3)) # torch.Size([8, 128, 64, 64]) -> torch.Size([1, 8, 128, 64, 64])
        x_2 = x_2.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 128, 8, 64, 64])
        x_2 = (
            F.adaptive_max_pool3d(x_2, (1, None, None))
            if requires_adaptive_max_pool3d
            else x_2
        )
        x_2 = x_2.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 8, 128, 64, 64])
        x_2 = x_2.view(-1, x_2.size(2), x_2.size(3), x_2.size(4)).contiguous() # torch.Size([8, 128, 64, 64])
        ...
        x_6 = F.relu(self.bn6_2(self.conv6_2(x_6))) # torch.Size([8, 128, 64, 64])

        x_1 = x_1.view(batch, -1, x_1.size(1), x_1.size(2), x_1.size(3)) # torch.Size([8, 64, 128, 128])->torch.Size([1, 8, 64, 128, 128])
        x_1 = x_1.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 64, 8, 128, 128])
        x_1 = (
            F.adaptive_max_pool3d(x_1, (1, None, None))
            if requires_adaptive_max_pool3d
            else x_1
        )
        x_1 = x_1.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 8, 64, 128, 128])
        x_1 = x_1.view(-1, x_1.size(2), x_1.size(3), x_1.size(4)).contiguous() # torch.Size([8, 64, 128, 128])
        ...
        x_7 = F.relu(self.bn7_2(self.conv7_2(x_7))) # torch.Size([8, 64, 128, 128])

        x = x.view(batch, -1, x.size(1), x.size(2), x.size(3)) # torch.Size([1, 8, 32, 256, 256])
        x = x.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 32, 8, 256, 256])
        x = (
            F.adaptive_max_pool3d(x, (1, None, None))
            if requires_adaptive_max_pool3d
            else x
        )
        x = x.permute(0, 2, 1, 3, 4).contiguous() # torch.Size([1, 8, 32, 256, 256])
        x = x.view(-1, x.size(2), x.size(3), x.size(4)).contiguous() # torch.Size([8, 32, 256, 256])
        ...
        # x_8 = F.interpolate(x_8, size=(512,512))
...
# Added by liuzhenghao: fix for ddp
class LidarEncoderBackbone(nn.Module):
    def __init__(self, height_feat_size, compress_level=0):
        super().__init__()
        self.conv_pre_1 = nn.Conv2d(
            height_feat_size, 32, kernel_size=3, stride=1, padding=1
...
# Added by liuzhenghao: fix for ddp
class LidarDecoderBackbone(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv5_1 = nn.Conv2d(512 + 256, 256, kernel_size=3, stride=1, padding=1)
        self.conv5_2 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x, x_1, x_2, x_3, x_4, batch, kd_flag=False):
        return self.decode(x, x_1, x_2, x_3, x_4, batch, kd_flag)
