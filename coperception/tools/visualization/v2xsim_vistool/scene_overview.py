...
camera_center_coords=(-100, 0, 80)
camera_focus_coords= (0 , 0.8396926, - 8.4202014)
camera_focus_coords = tuple(map(lambda x, y: x + y, camera_center_coords, camera_focus_coords))
...
def main():
    ...
    from_scene = 0
    to_scene = 0
    output_dir = './result_multi/scene_overview'

    dataset = SimpleDataset(root_dir=f'./dataset_processs/multi_drone_info', from_scene=from_scene, to_scene=to_scene)
