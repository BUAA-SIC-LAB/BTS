        ...
        for scene_idx in range(from_scene, to_scene + 1):
            ...
            for (i, data_info) in enumerate(dataset_infos):
                ...
                for cav_id in range(agent_start, cav_num + agent_start):
                    ...
                    self.keyframe_database[frame_idx][cav_id]['lidar'] = data_info[
                        f'lidar_path_{cav_id}']  # maybe add camera in the future
                    self.keyframe_database[frame_idx][cav_id]['params'] = OrderedDict()
                    self.keyframe_database[frame_idx][cav_id]['params']['lidar_pose'] = data_info[
                        f"lidar_pose_{cav_id}"]
                    ...
                    if cav_id == agent_start:
                        ...
                        self.keyframe_database[frame_idx][cav_id]['params']['object_ids'] = data_info[
...
if __name__ == '__main__':
    ...
    dataset = SimpleDataset(root_dir='./dataset_processs/multi_drone_info/', from_scene=0, to_scene=0)
