...
output_path = "./vis_seq"
root_dir = '/home/liuzhenghao/ROBOSAC/coperception/tools/visualization/v2xsim_vistool/dataset_processs/multi_drone_info'
...
def main():
    ## basic setting
    dataset = SimpleDataset(root_dir=root_dir,from_scene=0,to_scene=0)
